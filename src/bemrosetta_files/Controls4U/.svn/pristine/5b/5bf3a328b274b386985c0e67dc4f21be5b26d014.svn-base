...
[{_}%EN-US 
[ {{10000@3 [s0; [*@7;4 EditFile]]}}&]
[s1; &]
[s2;:EditFile`:`:class:%- [@(0.0.255)3 class][3 _][*3 EditFile][3 _:_][@(0.0.255)3 public][3 _][*^topic`:`/`/Controls4U`/src`/EditFileFolder`$en`-us`#EditFileFolder`:`:class^@3;3 E
ditFileFolder]&]
[s0;2 &]
...
[s4; &]
[s4; Pushing the left button a FileSel is opened to select a file. 
The options to setup the EditFile are similar to the used in 
the setup of a FileSel.&]
[s1; &]
[s0;2 &]
[ {{10000F(128)G(128)@1 [s0; [*2 Constructor Detail]]}}&]
[s1;%- &]
[s5;:EditFile`:`:EditFile`(`):%- [* EditFile]()&]
[s3; Initializes EditFile.&]
[s1; &]
[s0;%- &]
