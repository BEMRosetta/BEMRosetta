...
body_1 = cpt.FloatingBody(
            mesh=cpt.mesh_sphere(center=(0, 0, 0), name="Body 1"),
...
body_2 = cpt.FloatingBody(
            mesh=cpt.mesh_sphere(center=(0, 10, 0), name="Body 2"),
...
test_matrix = xr.Dataset({
        "omega": np.linspace(0.2, 6.0, 50),  # Can also specify "period", "wavelength" or "wavenumber"
...
cpt.export_dataset('results.nc', dataset, format="netcdf")
