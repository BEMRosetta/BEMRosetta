...
BEMRosetta runs in Windows and Linux and is done in C++, so it does not depend on any scripting language. [Install instructions are here](https://github.com/izabala123/BEMRosetta/tree/master/install).
