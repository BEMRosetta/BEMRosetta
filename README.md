...
BEMRosetta runs in Windows and Linux and is done in C++, so [install is simple](https://github.com/izabala123/BEMRosetta/tree/master/install) and it does not depend on any scripting language.
