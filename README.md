...
<img src="https://github.com/izabala123/BEMRosetta/blob/master/other/md%20resources/deepcwind.jpg" style="float: left; width: 40%; margin-right: 1%; margin-bottom: 0.5em;">style="float: left; width: 30%; margin-right: 1%; margin-bottom: 0.5em;" title="Mesh loaded in Windows"><img src="https://github.com/izabala123/BEMRosetta/blob/master/other/md%20resources/deepcwind_linux.jpg" style="float: left; width: 40%; margin-right: 1%; margin-bottom: 0.5em;">style="float: left; width: 30%; margin-right: 1%; margin-bottom: 0.5em;" title="Mesh in Linux"><p style="clear: both;">
